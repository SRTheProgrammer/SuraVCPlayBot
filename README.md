...
<b>Mandatory Vars</b>
1. `API_ID` : Get From [@api_scrapper_bot](https://t.me/api_scrapper_bot) or [my.telegram.org](https://my.telegram.org/)
2. `API_HASH` : Get From [@api_scrapper_bot](https://t.me/api_scrapper_bot) or [my.telegram.org](https://my.telegram.org)
3. `BOT_TOKEN` : [@Botfather](https://telegram.dog/BotFather)
4. `SESSION_STRING` : Generate From here [![GenerateStringName](https://img.shields.io/badge/repl.it-generateStringName-yellowgreen)](https://replit.com/@SRTheProgrammer/Session-Generator#main.py)
...
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/SRTheProgrammer/SuraVCPlayBot">
...
<p align="left">
<a href="https://railway.app/new/template?template=https://github.com/SRTheProgrammer/SuraVCPlayBot"
">
...
```sh
$ git clone https://github.com/SRTheProgrammer/SuraVCPlayBot.git
$ cd SuraVCPlayBot
...
- Pyrogram [String Session](https://replit.com/@SRTheProgrammer/Session-Generator#main.py) of the account.
